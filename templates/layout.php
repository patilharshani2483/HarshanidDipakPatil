...
<body>
  ...
  <header class="header">
    <nav class="navbar navbar-expand-lg bg-header navbar-dark py-lg-0">
      <div class="container-fluid">
        ...
        <button type="button" id="navar-toggle-button" data-toggle="collapse" data-target="#navbarSupportedContent"
          class="navbar-toggler navbar-toggler-right small"><span class="text-uppercase text-white mr-2">Menu</span><i
        ...
        <div id="navbarSupportedContent" class="collapse navbar-collapse">
          <ul class="navbar-nav ml-auto d-lg-flex align-items-lg-center">
            ...
            <li class="nav-item dropdown">
              <a id="navbarDropdownMenuLink" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                class="nav-link font-weight-bold px-lg-3 py-lg-4 dropdown-toggle">Animals</a>
              <div aria-labelledby="navbarDropdownMenuLink" class="dropdown-menu mt-0">
                ...
                foreach ($classifications as $key => $class) { ?>
                  <a href="animals?class_id=<?= $class['class_id'] ?>" class="dropdown-item small text-uppercase">
            ...
            <?php if (!(isset($_SESSION['user_type']) && $_SESSION['user_type'] == 'sponsor')) { ?>
              ...
              <li class="nav-item"><a href="ticket_page" class="nav-link font-weight-bold px-lg-3 py-lg-4">Book Tickets
                </a>
              </li>
            ...
            <?php } else { //sponsor links 
                ?>
              <li class="nav-item"><a href="post_testimonial" class="nav-link font-weight-bold px-lg-3 py-lg-4">Add
                  Testimonial</a>
              </li>
            <?php } ?>
            <?php if (!isset($_SESSION['authenticated'])) { ?>
              <li class="nav-item dropdown">
                <a href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                  class="nav-link font-weight-bold px-lg-3 py-lg-4 dropdown-toggle">Register</a>
            ...
            <?php if (!isset($_SESSION['authenticated'])) { ?>
              <li class="nav-item mt-4 mt-lg-0">
                <a type="button" href="login"
                  class="btn btn-outline-primary nav-btn btn-sm navbar-login-button text-white"> <i
                    class="fas fa-sign-out-alt mr-2"></i>Login </a>
              </li>
            <?php } else { ?>
              <li class="nav-item dropdown pr-2">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                  ...
                  <?php if (@$_SESSION['user_type'] == "visitor") { ?>
                    <a href="register_visitor?visitor_id=<?= $_SESSION['visitor_id'] ?>" class="dropdown-item">Update
                      Profile</a>
                  <?php } ?>
                  <?php if (@$_SESSION['user_type'] == "sponsor") { ?>
                    <a href="register_sponsor?sponsor_id=<?= $_SESSION['sponsor_id'] ?>" class="dropdown-item">Update
                      Profile</a>
                  <?php } ?>
                </div>
              </li>
  ...
  <footer style="background: #eee;" class="pt-5">
    ...
    <div class="container py-5">
      <div class="row">
        <div class="col-lg-8 col-md-6 mb-4">
          ...
          <p class="text-muted text-small">It is a long established fact that a reader will be distracted by the
          ...
          <p class="text-muted text-small">Many desktop publishing packages and web page editors now use Lorem Ipsum as
        ...
        <div class="col-lg-4 col-md-6 mb-4">
          ...
          <ul class="list-inline">
            <li class="list-inline-item"><a href="#" class="social-link facebook-logo"><i
                  class="fab fa-facebook-f"></i></a></li>
            <li class="list-inline-item"><a href="#" class="social-link googleplus-logo"><i
                  class="fab fa-google-plus-g"></i></a></li>
            <li class="list-inline-item"><a href="#" class="social-link twitter-logo"><i class="fab fa-twitter"></i></a>
            </li>
            <li class="list-inline-item"><a href="#" class="social-link mail-logo"><i class="fas fa-envelope"></i></a>
            </li>
          </ul>
        </div>
    ...
    <div class="bg-header py-2 text-center text-white">
      <p class="p-0 m-0">&copy;
        <?php echo date('Y') ?> - Zoo Management System
      </p>
    </div>
  </footer>
  <!-- JavaScript files-->
